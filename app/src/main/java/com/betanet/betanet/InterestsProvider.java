...
public class InterestsProvider extends ContentProvider {
    private static final String AUTHORITY = "com.betanet.betanet";
    static final String PROVIDER_NAME = "com.betanet.betanet.InterestsProvider";
    static final String URL = "content://" + PROVIDER_NAME + "/interests";
    static final Uri CONTENT_URI = Uri.parse(URL);
    private static final String TAG = "InterestsProvider";
    static final UriMatcher uriMatcher = buildUriMatcher();
    private static UriMatcher buildUriMatcher(){
        UriMatcher uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        return uriMatcher;
    }
    String[] interestsList = new String[]{"Lion", "Tiger", "Dog",
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        for(String interest:interestsList) {
            if(interest.toLowerCase().contains(query.toLowerCase())) {
                Log.e(TAG, "query: match = "+ interest);
                matrixCursor.addRow(new Object[]{i++, interest, "", interest});
            }
        }
